...
class Vapi extends VapiEventEmitter {
  ...
  constructor(apiToken, apiBaseUrl, dailyCallConfig, dailyCallObject) {
    super();
    client_1.client.baseUrl = apiBaseUrl ?? "https://api.getoutbox.ai";
  ...
  async start(agent, assistantOverrides, squad, workflow, workflowOverrides) {
    ...
    try {
      ...
      const webCall = (
        await client_1.client.call.callControllerCreateAgentWebCall(agentId, {
          assistantOverrides,
      ...
      this.emit("call-start-progress", {
        ...
        metadata: {
          ...
          videoSource:
            this.dailyCallObject.videoSource ?? isVideoRecordingEnabled,
